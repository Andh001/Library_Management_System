...
<body>
    ...
    <div class="two">
        ...
        <div class="search">
            ...
            <select class="text" name="SearchBooksBy">
            <option value="name">Name</option>
            <option value="publisher">Publisher</option>
            <option value="author">Author</option>
            </select>
            
            <input class="text" type="text" value="Name" name="name">
        ...
        <div class="books">
           <h3>Register</h3>
            <div class="btn1"><a href="#">
            <div class="f1"><h3>Issued Books</h3></div>
            </a></div>
            <br>
            <div class="btn1">
                <a href="#"><div class="f1"><h3>Reference Books</h3></div>
            </a></div>
        </div>
        </div>
    </div>
