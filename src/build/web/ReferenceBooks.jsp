...
<body>
    ...
    <tbody>
        ...
        <%
            ...
            //user.setUsername("andh001");
            //user.setPassword("111");
            user.load();
            ResultSet rs = Executor.exer("SELECT ID,NAME,AUTHOR,PUBLISHER,STOCK FROM LIBRARY2 WHERE TYPE LIKE('%ref%')");
        ...
        <tr>
            ...
            <td><div class="hh"><%out.print(rs.getString("Author"));%></div></td>
            <td><div class="hh"><%out.print(rs.getString("Publisher"));%></div></td>
            <td><div class="hh"><%out.print(rs.getString("STOCK"));%></div></td>
